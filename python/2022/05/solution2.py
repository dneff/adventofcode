...
This script simulates moving multiple crates at once between stacks.
"""
...
def move_crates(cargo, count, src, dest):
    """
    Move multiple crates at once from source to destination stack (preserving order).
    ...
    # Don't reverse - move all at once preserving order
    cargo[dest].extend(grab)


def solve_part2():
    """
    Simulate crate movements (multiple at once) and return the top crates.
