...
def breadth_search(start, end, grid):
    """
    breadth_search: a BFS search, return length of shortest uphill path
    """
...
def main():
    ...
    with open("../input/12.txt", "r", encoding="utf-8") as f:
    ...
    print_solution(breadth_search(start, end, grid))
