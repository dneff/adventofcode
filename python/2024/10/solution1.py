...
def find_sequences(grid, starting_position, visited=None):
    """Recursively finds all possible ending positions from a starting position.
    ...
    Returns:
        list: unique ending positions found from this position
    ...
    return list(set(ending_positions))
