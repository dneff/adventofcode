"""
Advent of Code 2016 - Day 10: Balance Bots (Part 1)
...
Goal: Find which bot is responsible for comparing value-61 and value-17 microchips.
"""
...
def main():
    ...
    def process_bot(bot_id):
        ...
        # Check if this bot is comparing chips 17 and 61
        if 17 in chips and 61 in chips:
            print(f"Bot {bot_id} is responsible for comparing value-17 and value-61 microchips")
            AoCUtils.print_solution(1, bot_id)
            exit()
